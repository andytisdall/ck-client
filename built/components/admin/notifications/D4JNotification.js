...
var HomeChefNotification = function () {
    var _a = __read((0, d4jApi_1.useSendD4JNotificationMutation)(), 2), sendD4JNotification = _a[0], isLoading = _a[1].isLoading;
    var _b = (0, d4jApi_1.useGetD4JNotificationsQuery)(), pastNotifications = _b.data, pastLoading = _b.isLoading;
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("h2", { children: ["Send a ", (0, jsx_runtime_1.jsx)("span", { className: "admin-app-name", children: "Dining for Justice App" }), ' ', "Push Notification"] }), (0, jsx_runtime_1.jsx)(NotificationForm_1.default, { onSubmit: sendD4JNotification, isLoading: isLoading }), pastLoading ? (0, jsx_runtime_1.jsx)(Loading_1.default, {}) : renderPastNotifications()] }));
};
