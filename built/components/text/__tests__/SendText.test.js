...
test('navigate to text page', function () { return __awaiter(void 0, void 0, void 0, function () {
    var textLink, headerText;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, react_1.render)((0, jsx_runtime_1.jsx)(App_1.default, {}), { wrapper: setupTests_1.Root });
                return [4 /*yield*/, react_1.screen.findAllByText('Text Service')];
            case 1:
                textLink = _a.sent();
                if (!textLink[0]) return [3 /*break*/, 3];
                return [4 /*yield*/, user_event_1.default.click(textLink[0])];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [4 /*yield*/, react_1.screen.findByRole('heading', {
                    level: 1,
                    name: 'Text Service',
                })];
            case 4:
